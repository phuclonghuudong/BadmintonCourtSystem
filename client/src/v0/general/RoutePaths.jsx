export const RoutePaths = {
  ...
  MANAGE_GROUP_PERMISSIONS: "/manage/group-permission",
  MANAGE_FUNCTIONAL_CATEGORY: "manage/functional-category",
...
export const Routes = {
  ...
  MANAGE_GROUP_PERMISSIONS: {
    path: "/manage/group-permission",
    label: "nhóm quyền",
    layout: "AdminLayout",
    roles: ["admin"],
    icon: "fa-solid fa-users-rays",
  },
  MANAGE_FUNCTIONAL_CATEGORY: {
    path: "/manage/functional-category",
